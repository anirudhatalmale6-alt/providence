...
TERMS = [
    "Shixart1985 interior",
    "interior design living room sofa cushions",
    "scandinavian interior living room",
    "minimalist interior bedroom design",
    "bathroom interior design modern sink",
    "kitchen interior design wooden",
    "apartment interior design neutral",
    "hotel lobby lounge interior seating",
]
...
for i, p in enumerate(picked, 1):
    ...
    try:
        ...
        print("  FAILED", dest, e)
    time.sleep(2.0)
json.dump(creds, open("img/candidates2.json","w"), indent=1)
